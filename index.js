		...
		try {
			...
			mess = {
				...
				only: {
					...
					mod: '[❗] ESTE PEDIDO É ESPECÍFICO PARA USUARIO MOD SHAOLIN BOT*',
					...
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, irmã. Você não está registrado como amigo de shaolin. Registre-se para fazer amizade com o bot Shaolin por meio, \n\nCommand : ${prefix}daftar nama|idade\nExemplo : ${prefix}daftar nabuto|14\n\n──「 Shaolin BOT 」──`,
			...
			const ownerNumber = ["559887583208@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"559887583208@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["559887583208@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["559887583208@s.whatsapp.net"]//ubah nomor lo
			const premium = ["559887583208@s.whatsapp.net","553188115277@s.whatsapp.net","559384051080@s.whatsapp.net","559885867761@s.whatsapp.net","5511949051934@s.whatsapp.net","554792091566@s.whatsapp.net","558699541889@s.whatsapp.net","559294313229@s.whatsapp.net","554298653614@s.whatsapp.net"]
...
// recursos anime, random @nabuto domina vida
          ...
          reply('Espere..')
			    ...
			    case 'dono':
                    ...
                    client.sendMessage(from, 'Meu dono é esse gasoso aí tal de "shaolin"🙄, chama ele aí ele diz que é "Shitpost"',MessageType.text, { quoted: mek} )
                    break
                case 'fitnah':	
				case 'fake':          
                    if (!isGroup) return reply(mess.only.group)
